...
The reference genome includes IDs for each gene from the ENSEMBL database. This is why each row in the dataframe has an ENSG______ ID, specifying the tpm for a given gene. We can convert these IDs to real gene names by using packages in R. 
